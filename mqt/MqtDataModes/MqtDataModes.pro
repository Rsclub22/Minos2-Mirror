...
else:win32-clang-g++:CONFIG(release, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../maia/release/libmaia.a
else:win32-clang-g++:CONFIG(debug, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../maia/debug/libmaia.a
