...
int OmnirigControl::setConfigurationParameter(int rigNumber, QString cfgparam, QString value)
{
    Q_UNUSED(rigNumber)
    Q_UNUSED(cfgparam)
    Q_UNUSED(value)
...
int OmnirigControl::getConfigurationParameter(int rigNumber, QString cfgparam, QString *value)
{
    Q_UNUSED(rigNumber)
    Q_UNUSED(cfgparam)
    Q_UNUSED(value)
