...
const QString RUN_BUTTON_OFF_FREQ_STYLE = QString("background-color: blue ; color:white ; border-style: outset; border-width: 1px; border-color: black; min-width: 5em; padding: 3px;\n");
