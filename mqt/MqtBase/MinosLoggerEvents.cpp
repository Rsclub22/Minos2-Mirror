...
//---------------------------------------------------------------------------
void MinosLoggerEvents::SendAfterLogContactToBandmap(BaseContestLog *ct, QSharedPointer<BaseContact> lct, bool cqResp)
{
    emit mle.AfterLogContactToBandmap(ct, lct, cqResp);
}
//---------------------------------------------------------------------------
