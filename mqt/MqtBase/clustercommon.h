...
// Cluster View Columns

const int RXTIME_COL_NUM = 0;

const int TIME_COL_NUM = 1;
const int FREQ_COL_NUM = 2;
const int DXSPOT_CALL_COL_NUM = 3;
const int DXSPOT_MODE_COL_NUM = 4;
const int DXLOC_COL_NUM = 5;
const int DXDIST_COL_NUM = 6;
const int DXBRG_COL_NUM = 7;
const int SPOTTER_CALL_COL_NUM = 8;
const int SPOTTER_LOC_COL_NUM = 9;
...
const bool ADD_TUNING_BANDMAP_FREQ_DEFAULT_ENABLED = true;
...
const int ADD_TUNING_BANDMAP_FREQ_DEFAULT_TOLERANCE_CW = 200;   // hz
const int ADD_TUNING_BANDMAP_FREQ_DEFAULT_MIN_TOLERANCE_CW = 20;   // hz
const int ADD_TUNING_BANDMAP_FREQ_DEFAULT_MAX_TOLERANCE_CW = 1000;   // hz

const int ADD_TUNING_BANDMAP_FREQ_DEFAULT_TOLERANCE_PHONE = 1500;   // hz
const int ADD_TUNING_BANDMAP_FREQ_DEFAULT_MIN_TOLERANCE_PHONE = 500;   // hz
const int ADD_TUNING_BANDMAP_FREQ_DEFAULT_MAX_TOLERANCE_PHONE = 15000;   // hz

const int ADD_TUNING_BANDMAP_FREQ_DEFAULT_TOLERANCE_DATA = 200;   // hz
const int ADD_TUNING_BANDMAP_FREQ_DEFAULT_MIN_TOLERANCE_DATA = 10;   // hz
const int ADD_TUNING_BANDMAP_FREQ_DEFAULT_MAX_TOLERANCE_DATA = 1000;   // hz
