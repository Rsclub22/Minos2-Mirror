...
BundleFile::BundleFile( PROFILES p )
{
    ...
    case epLOGGERPROFILE:
        ...
        entries.push_back(  QSharedPointer<ProfileEntry> (new ProfileEntry( elpAddBandMapTuningEnableCW , "addBandmapTuningENABLECW", ADD_TUNING_BANDMAP_FREQ_DEFAULT_ENABLED, QT_TR_NOOP("Add to Bandmap tuning CW enabled"), QT_TR_NOOP("Add to Bandmap tuning CW enabled"), false ) ) );
        entries.push_back(  QSharedPointer<ProfileEntry> (new ProfileEntry( elpAddBandMapTuningEnableDATA , "addBandmapTuningENABLEDATA", ADD_TUNING_BANDMAP_FREQ_DEFAULT_ENABLED, QT_TR_NOOP("Add to Bandmap tuning Data enabled"), QT_TR_NOOP("Add to Bandmap tuning Data enabled"), false ) ) );
        entries.push_back(  QSharedPointer<ProfileEntry> (new ProfileEntry( elpAddBandMapTuningEnablePHONE , "addBandmapTuningENABLEPHONE", ADD_TUNING_BANDMAP_FREQ_DEFAULT_ENABLED, QT_TR_NOOP("Add to Bandmap tuning Phone enabled"), QT_TR_NOOP("Add to Bandmap tuning Phone enabled"), false ) ) );
        entries.push_back(  QSharedPointer<ProfileEntry> (new ProfileEntry( elpAddBandMapTuningToleranceCW , "addBandmapTuningToleranceCW", ADD_TUNING_BANDMAP_FREQ_DEFAULT_TOLERANCE_CW, QT_TR_NOOP("Add to Bandmap tuning tolerance CW"), QT_TR_NOOP("Add to Bandmap tuning tolerance CW"), false ) ) );
        entries.push_back(  QSharedPointer<ProfileEntry> (new ProfileEntry( elpAddBandMapTuningTolerancePHONE , "addBandmapTuningTolerance", ADD_TUNING_BANDMAP_FREQ_DEFAULT_TOLERANCE_PHONE, QT_TR_NOOP("Add to Bandmap tuning tolerance Phone"), QT_TR_NOOP("Add to Bandmap tuning tolerance Phone"), false ) ) );
        entries.push_back(  QSharedPointer<ProfileEntry> (new ProfileEntry( elpAddBandMapTuningToleranceDATA , "addBandmapTuningToleranceDATA", ADD_TUNING_BANDMAP_FREQ_DEFAULT_TOLERANCE_DATA, QT_TR_NOOP("Add to Bandmap tuning tolerance Data"), QT_TR_NOOP("Add to Bandmap tuning tolerance Data"), false ) ) );
