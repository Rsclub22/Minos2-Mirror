...
BundleFile::BundleFile( PROFILES p )
{
    ...
    case epLOGGERPROFILE:
        ...
        entries.push_back(  QSharedPointer<ProfileEntry> (new ProfileEntry( elpWSJTXUdpRecEnabled, "WSJTXUdpRecEnabled", false, QT_TR_NOOP("WSJTX UDP record Enabled"), QT_TR_NOOP("WSJTX udpRecord Enabled"), false ) ) );
        ...
        entries.push_back(  QSharedPointer<ProfileEntry> (new ProfileEntry( elpBandmapStartZoomLevel_1_8MHz , "bandmapStartZoomLevel_1_8MHz", dialData::START_ZOOM_LEVEL, QT_TR_NOOP("Bandmap Start Zoomlevel 1.8MHz"), QT_TR_NOOP("Bandmap Start Zoomlevel 1.8MHz"), false ) ) );
        entries.push_back(  QSharedPointer<ProfileEntry> (new ProfileEntry( elpBandmapStartZoomLevel_3_5MHz , "bandmapStartZoomLevel_3_5MHz", dialData::START_ZOOM_LEVEL, QT_TR_NOOP("Bandmap Start Zoomlevel 3.5MHz"), QT_TR_NOOP("Bandmap Start Zoomlevel 3.5MHz"), false ) ) );
        entries.push_back(  QSharedPointer<ProfileEntry> (new ProfileEntry( elpBandmapStartZoomLevel_7MHz , "bandmapStartZoomLevel_7MHz", dialData::START_ZOOM_LEVEL, QT_TR_NOOP("Bandmap Start Zoomlevel 7MHz"), QT_TR_NOOP("Bandmap Start Zoomlevel 7MHz"), false ) ) );
        entries.push_back(  QSharedPointer<ProfileEntry> (new ProfileEntry( elpBandmapStartZoomLevel_14MHz , "bandmapStartZoomLevel_14MHz", dialData::START_ZOOM_LEVEL, QT_TR_NOOP("Bandmap Start Zoomlevel 14MHz"), QT_TR_NOOP("Bandmap Start Zoomlevel 14MHz"), false ) ) );
        entries.push_back(  QSharedPointer<ProfileEntry> (new ProfileEntry( elpBandmapStartZoomLevel_21MHz , "bandmapStartZoomLevel_21MHz", dialData::START_ZOOM_LEVEL, QT_TR_NOOP("Bandmap Start Zoomlevel 21MHz"), QT_TR_NOOP("Bandmap Start Zoomlevel 21MHz"), false ) ) );
        entries.push_back(  QSharedPointer<ProfileEntry> (new ProfileEntry( elpBandmapStartZoomLevel_28MHz , "bandmapStartZoomLevel_28MHz", dialData::START_ZOOM_LEVEL, QT_TR_NOOP("Bandmap Start Zoomlevel 28MHz"), QT_TR_NOOP("Bandmap Start Zoomlevel 28MHz"), false ) ) );
