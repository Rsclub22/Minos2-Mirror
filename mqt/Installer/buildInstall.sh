...
if [ $retVal -ne 0 ]; then
  ...
  for j in TinyXML XMPPLib KeyerBase MqtBase MqtUtils MqtAppStarter MqtChat MqtCluster MqtDataModes MqtKSTClient MqtLogger MqtMonitor MqtQrzServer MqtRigControl MqtRigSync MqtRigRecorder MqtRotator MqtServer
  do
...
do
  for j in MqtAppStarter MqtChat MqtCluster MqtDataModes MqtKSTClient MqtLogger MqtMonitor MqtQrzServer MqtRigControl MqtRigSync MqtRigRecorder MqtRotator MqtServer
  do
...
wget https://www.rsgbcc.org/vhf/hfcontests22.xml -O hfcontests22.xml
wget https://www.rsgbcc.org/vhf/hfcontests23.xml -O hfcontests23.xml

wget https://microwave.rsgbcc.org/microcontests22.xml -O microcontests22.xml
